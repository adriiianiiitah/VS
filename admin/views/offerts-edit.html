                ...
                <form id="" class="form-horizontal form-label-left" onsubmit="return validate()" data-validate>
                  <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12">
                    <div class="profile_img">
                      <div id="crop-avatar">
                        <div>
                          <img id="image-file" src="../img/categories/category.png" alt="offerts" class="img-thumbnail">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-8 col-md-7 col-sm-6 col-xs-12"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12">
                        <input type="number" id="quantity" name="quantity" min="0" step="1" class="form-control col-md-7 col-xs-12"  data-required data-integer/>
                      </div>
                    </div>
                    <div class="form-group">
