                  ...
                  <div class="col-lg-8 col-md-7 col-sm-6 col-xs-12"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="sizes" data-checked>Bra
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="sizes" data-checked>Panties
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="sizes" data-checked>Pajamas
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="sizes" data-checked>Sport
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="sizes" data-checked>Lingerie
                          </label>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12">
                        <textarea id="description" name="description" class="form-control col-md-7 col-sm-12 col-xs-12" class="form-control" rows="3" data-required data-description></textarea>
                      </div>
                    </div>
                    <div class="form-group">
